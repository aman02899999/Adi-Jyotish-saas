  ...
  return (
    <main className="marketing-page legal-page">
      ...
      <section className="shell legal-body">
        ...
        <p>Vedic astrology, numerology, Panchang, Kundli matching, and AI-generated readings offered through Jyotish are provided for guidance, reflection, and entertainment. They are <strong>not a substitute for professional medical, legal, financial, or psychological advice</strong>, and we do not guarantee any specific outcome, event, or result from following a reading, remedy, or recommendation. Decisions about your health, finances, relationships, or legal matters remain entirely your own responsibility.</p>
        ...
        <p>Payments are processed securely through Razorpay; we never see or store your full card, UPI, or bank details. Wallet balances are used to pay for chat/call consultations by the minute. Memberships renew automatically at the interval you select until you cancel from your dashboard. See our <a href="/refund-policy">Refund &amp; Cancellation Policy</a> for how refunds and cancellations work for each type of purchase.</p>

        <h2>6. Gemstone orders</h2>
        <p>Gemstones and related products are sold as described on their product pages. Natural gemstones vary in inclusion, tone, and cut — minor natural variation from photographs is expected and is not a defect. See our <a href="/refund-policy">Refund &amp; Cancellation Policy</a> for returns.</p>
