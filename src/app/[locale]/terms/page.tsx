  ...
  return (
    <main className="marketing-page legal-page">
      ...
      <section className="legal-hero shell">
        ...
        <p>The agreement between you and Adi Jyotish Guru covering readings, the practitioner marketplace, memberships, gemstone orders, and everything else on this site.</p>
      ...
      <section className="shell legal-body">
        ...
        <p>Practitioners listed on Jyotish are independent professionals, not employees of Adi Jyotish Guru. We review credentials and experience before a practitioner is published, and we moderate reviews, but we do not control the content of an individual consultation. Any dispute about the quality or content of a specific reading should first be raised with us at <a href={`mailto:${settings.supportEmail}`}>{settings.supportEmail}</a> so we can help mediate.</p>
        ...
        <p>The Jyotish name, design, calculation engines, and written content are owned by Adi Jyotish Guru or its licensors. Your own birth details and the readings generated for you are yours to keep and use personally; you may not resell or redistribute Service content commercially without our written permission.</p>

        <h2>9. Limitation of liability</h2>
        <p>To the fullest extent permitted by law, Adi Jyotish Guru is not liable for indirect, incidental, or consequential damages arising from your use of the Service, including decisions made in reliance on a reading. Our total liability for any claim is limited to the amount you paid us for the specific service giving rise to the claim in the preceding twelve months.</p>
        ...
        <p>These Terms are governed by the laws of India. Any dispute not resolved informally is subject to the exclusive jurisdiction of the courts where Adi Jyotish Guru is registered.</p>
