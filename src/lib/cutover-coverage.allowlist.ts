...
export const FIRESTORE_ONLY: Record<string, string> = {
  ...
  "src/lib/homepage.ts#getFeaturedTestimonials": NOT_YET_PORTED,
  "src/lib/homepage.ts#getHomepageStats": NOT_YET_PORTED,
  "src/lib/homepage.ts#getOnlineNowCount": NOT_YET_PORTED,
  "src/lib/promo-banner.ts#getPromoBanner": NOT_YET_PORTED,
  "src/lib/promo-banner.ts#updatePromoBanner": NOT_YET_PORTED,
  ...
  "src/lib/site-content.ts#getFooterContent": NOT_YET_PORTED,
  "src/lib/site-content.ts#getHomeHeroContent": NOT_YET_PORTED,
  "src/lib/site-content.ts#updateFooterContent": NOT_YET_PORTED,
  "src/lib/site-content.ts#updateHomeHeroContent": NOT_YET_PORTED,
};
