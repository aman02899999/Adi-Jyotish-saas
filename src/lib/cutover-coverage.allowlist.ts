...
export const FIRESTORE_ONLY: Record<string, string> = {
  ...
  "src/app/api/practitioners/[id]/route.ts": NOT_YET_PORTED,
  "src/app/api/practitioners/route.ts": NOT_YET_PORTED,
  ...
  "src/lib/practitioner-auth.ts#findPractitionerByUid": NOT_YET_PORTED,
  "src/lib/scheduling.ts#createPractitionerAdmin": NOT_YET_PORTED,
  "src/lib/scheduling.ts#deletePractitionerAdmin": NOT_YET_PORTED,
  ...
  "src/lib/scheduling.ts#updatePractitionerAdmin": NOT_YET_PORTED,
