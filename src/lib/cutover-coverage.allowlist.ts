...
export const FIRESTORE_ONLY: Record<string, string> = {
  ...
  "src/app/[locale]/practitioner/invite/[token]/page.tsx": NOT_YET_PORTED,
  "src/app/[locale]/practitioner/profile/page.tsx": NOT_YET_PORTED,
  "src/app/api/admin/invites/[id]/route.ts": NOT_YET_PORTED,
  "src/app/api/admin/practitioner-payouts/[id]/route.ts": NOT_YET_PORTED,
  "src/app/api/admin/practitioners/[id]/invite/route.ts": NOT_YET_PORTED,
